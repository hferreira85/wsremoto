...
public class j_CustoCarroConsumidor {
	...
	public static void main(String[] args) {
		...
		double precoFabrica = Double.parseDouble(JOptionPane.showInputDialog("Informe o preço de fábrica"));
		...
		System.out.println("O lucro do distribuidor é: " + lucroDistribuidor);
		System.out.println("O valor correspondente aos impostos é: " + percentualImpostos);
		System.out.println("O preços final do veículo é: " + (precoFabrica + lucroDistribuidor + percentualImpostos));
